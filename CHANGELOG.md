...
### Changed
- Telemetry bottom border compacted (`>60.6 tok/s · ~2.5s · +8.3s · ↑395 · ↓505 · $0.16` not `> TPS 60.6 tok/s | ~ TTFT 2.5s | + 8.3s | ↑ 395 | ↓ 505 | $0.16`; no `TPS`/`TTFT` labels, no space after `↑`/`↓`/`>`/`~`/`+`, joiner `·` not ` | `, stall `!2·3.3s` not `! stall 2x / 3.3s`)
