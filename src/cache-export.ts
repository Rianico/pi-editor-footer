...
/** Structural slice of pi's SessionManager used for the output file name. */
export interface SessionNameSource {
  getSessionName(): string | undefined;
  getSessionFile(): string | undefined;
}

function resolveSessionBaseName(sessionManager: SessionNameSource): string {
